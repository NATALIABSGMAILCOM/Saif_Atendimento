...
<head>
  ...
  <title>Tela do Antendente</title>
...
<section class="mbr-section form1 cid-r0ZKcOSVFP" id="form1-1l" data-rv-view="331">
    ...
    <div class="container">
        ...
        <div style="width: 70%; margin-left: auto; margin-right: auto;">
            <button type="button" class="btn btn-outline-secondary" style="height: 60px;width: 80px;font-size: 2.5em;padding: 0px;color: #147eba;border: 3px solid #147eba; margin-top: 0.2em"><?= $this->session->userdata("saif_usuario")->guiche_atual; ?> </button>
            ...
            <div class="block-content align-left  ">
                <div class="card pl-3 pr-3 pb-5">
                    <div class="mbr-card-img-title">
                        ...
                        <form class="b2" method="post" action="principal/proximaFicha/<?=$qnt->id?>/<?=$this->session->userdata('saif_usuario')->guiche_atual?>">
                            <button type="submit" class="btn btn-primary" style=" top: -20px; width: 250px; height: 60px; right: 3.0rem; position: relative">Chamar Próxima</button>
                        </form>     
                    </div>                
