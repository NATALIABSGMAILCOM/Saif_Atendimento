    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="menu-logo">
            <div class="navbar-brand">
                ...
                <span class="navbar-caption-wrap"><a class="navbar-caption text-white display-4" href="<?= base_url()?>Principal/meus_dados"></a></span>
            </div>
        </div>
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <a href="<?= base_url(); ?>Principal/meus_dados"  class="fa fa-user-circle-o coricone" style="font-size:27px"></a>
            <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true"><li class="nav-item">
                    
                    <a class="nav-link link text-white display-4" href="<?= base_url()?>Principal/meus_dados"></a>
                    
                </li><li class="nav-item"><a class="nav-link link text-white display-4" href="<?= base_url()?>Principal/meus_dados">
                        Olá, atendente</a></li><li class="nav-item dropdown"><a class="nav-link link text-white dropdown-toggle display-4" href="<?= base_url()?>Principal/meus_dados" data-toggle="dropdown-submenu" aria-expanded="false"></a>
...
<section class="mbr-section form1 cid-r0ZKcOSVFP" id="form1-1l" data-rv-view="331">
    ...
    <div class="container">
        <p style="color:#147eba; font-size:21px; top: 10px">Editar CPF</p>
        <div class="bloco1">
        <div class="campo1">
           <p>CPF:</p>
            <div class="um">
                <form action="Principal/atualizar_cpf" method="post">
                <input style="width: 263px; border: 1px solid #C0C0C0" type="text" name="cpf" id="cpf" required placeholder=" " pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" maxlength="14" class="" placeholder="">
                ...
                <form method="post" action="<?=base_url(); ?>principal/tela_atendente">
