...
<section class="menu cid-r0ZJ6Qpu31" once="menu" id="menu1-1i" data-rv-view="329">
    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <a href="<?= base_url(); ?>Principal/add_guiche" class="fa fa-user-circle-o coricone" style="font-size:27px"></a>
            <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true"><li class="nav-item">
                    <a class="nav-link link text-white display-4" href="<?= base_url(); ?>Principal/add_guiche"></a>
                </li><li class="nav-item"><a class="nav-link link text-white display-4" href="<?= base_url(); ?>Principal/add_guiche">
                        Olá, atendente</a></li>
...
<section class="engine"><a href="#">free bootstrap theme</a>
</section>
    <section class="mbr-section form1 cid-r0ZKcOSVFP" id="form1-1l" data-rv-view="331">
        ...
        <div class="row justify-content-center">
            ...
            <div class="alert alert-secondary" style="color: #147eba" role="alert">
                Essa ação irá Reiniciar a Sessão em Andamento, e será criada uma Nova Sessão!
            </div>
            
                <h2 class="mbr-section-title align-center pb-3 mbr-fonts-style display-2">Adicionar Guichê</h2>
                <form name="formularioModalidade" method="post" action="<?=base_url();?>Usuario/add_Guiche" >
