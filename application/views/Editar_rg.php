...
<section class="mbr-section form1 cid-r0ZKcOSVFP" id="form1-1l" data-rv-view="331">
    ...
    <div class="container">
        <p style="color:#147eba; font-size:21px; top: 10px">Editar RG</p>
        <div class="bloco1">
        <div class="campo1">
           <p>RG:</p>
            <div class="um">
                <form action="principal/atualizar_rg" method="post">
                    <input style="width: 263px; border: 1px solid #C0C0C0" type="text" name="rg" id="rg" required placeholder=" " pattern="\d{2}\.\d{3}\.\d{3}-\d{1}" maxlength="13" class="" placeholder="">
