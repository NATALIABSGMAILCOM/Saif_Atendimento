...
<section class="mbr-section form1 cid-r0ZKcOSVFP" id="form1-1l" data-rv-view="331">
    ...
    <div class="container">
        <p style="color:#147eba; font-size:21px; top: 10px">Editar Nome</p>
        <div class="bloco1">
        <div class="campo1">
           <p>Nome:</p>
            <div class="um">
                 <form action="Principal/atualizar_nome" method="post">
                    <input style="width: 263px; border: 1px solid #C0C0C0" type="text" name="nome" class="" placeholder="" required>
